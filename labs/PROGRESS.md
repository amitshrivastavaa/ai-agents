...
| 4 | `prompt_evolver` | evolutionary/genetic prompt optimizer over a task suite (DSPy/evo-prompt) | ⏳ next |
...
- Build MVP #4 `prompt_evolver`. Then #5+. Keep going down the table.
